...
@section('content')
    ...
    <div class="space-y-3">
        <a href="{{ route('reports.admin', $token) }}" class="flex items-center gap-4 bg-white rounded-3xl shadow-sm ring-1 ring-slate-100 active:scale-[.99] transition p-4">
        ...
        <a href="{{ route('promos.admin', $token) }}" class="flex items-center gap-4 bg-white rounded-3xl shadow-sm ring-1 ring-slate-100 active:scale-[.99] transition p-4">
        ...
        <a href="{{ route('sync', $token) }}" class="flex items-center gap-4 bg-white rounded-3xl shadow-sm ring-1 ring-slate-100 active:scale-[.99] transition p-4">
